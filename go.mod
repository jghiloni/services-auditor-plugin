module github.com/jghiloni/services-auditor-plugin
...
require (
	...
	github.com/cloudfoundry/bosh-utils v0.0.0-20190921100139-64e3370c6fb0 // indirect
	github.com/cloudfoundry/cli-plugin-repo v0.0.0-20190918170341-3d7a270ed562 // indirect
